...
void Environment::buildPipes(){
    ...
    for(int i = 0; i < amount; i++){
        ...
        topPipes.push_back(new TexRect(pipe_image, (3.0 + ((float)i*pipe_offset)), 2.0 - randomHeight, 0.3, 1.6));
        bottomPipes.push_back(new TexRect(pipe_image, (3.0 + ((float)i*pipe_offset)), -2.0 - randomHeight, 0.3, -1.6) );
    }
}
